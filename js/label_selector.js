...
function labelSelector(id) {
        if ((document.getElementById('btn'+id).value != 'End Here # '+id)
            && (document.getElementById('btn'+id).value != 'Start Here #'+id)) { // to select 1 item only
    ...
    if (document.getElementById('btn'+id).value == 'Start Here #'+id) {
        ...
        for (var i = 1; i <= 7; i++) {
            if (document.getElementById('selection'+i).style.backgroundColor == 'limegreen') {
                document.getElementById('btn'+id).value = document.getElementById('selection'+i).value;
                document.getElementById(id).value = document.getElementById('selection'+i).name;
            } else {
        ...
        for (var i = id+1; i <= 12; i++) {
            if (document.getElementById('btn'+i).style.backgroundColor == 'limegreen') {
                break;
            } else {
